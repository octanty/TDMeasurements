    ...
    <body>
        <div id="wrapper">
            <div id="header">  
                ...
                <ul>
                    <li><a href="<c:url value="/employee/list" />"><div class="img1"></div><p><spring:message code="navigation.employee"/></p></a></li>
                    <li><a href="<c:url value="/journey/list" />"><div class="img2" ></div><p><spring:message code="navigation.journey"/></p></a></li>
                    <li><a href="<c:url value="/car/list" />"><div class="img3" ></div><p><spring:message code="navigation.car"/></p></a></li>
                    <li><a href="<c:url value="/service/list" />"><div class="img5" ></div><p><spring:message code="navigation.service"/></p></a></li>                             
                </ul> 
            </div>
            <div id="error">  
