            ...
            $.validationEngineLanguage.allRules = {
                "required": { // Add your regex rules here, you can take telephone as an example
                 ...
                 "requiredInFunction": { 
                    ...
                    "alertText": "* Pole sa musí rovnať test"
                },
                "minSize": {
                    "regex": "none",
                    "alertText": "* Minimálne ",
				...
				"groupRequired": {
                    "regex": "none",
                    "alertText": "* Musíte zadať jedno z nasledujúcich polí"
                },
                "min": {
                    "regex": "none",
                ...
                "maxCheckbox": {
                    "regex": "none",
                    "alertText": "* Počet vybraných položek presiahol limit"
                },
                "minCheckbox": {
                    "regex": "none",
                ...
                "CZphone": {
                    ...
                    "alertText": "* Neplatné telefónne číslo, zadejte vo formátu +420 598-598-895"
                },
                "phone": {
                ...
                "CZdate": {
                    ...
                    "alertText": "* Neplatný dátum, dátum musí byť vo formátu den.mesiac.rok (dd.mm.rrrr)"
                },
                "date": {
                    // Date in ISO format. Credit: bassistance
                    "regex": /^\d{4}[\/\-](0?[1-9]|1[012])[\/\-](0?[1-9]|[12][0-9]|3[01])$/,
                    "alertText": "* Neplatný dátum, dátum musí byť vo formátu YYYY-MM-DD"
                },
                "ipv4": {
                ...
                "psc": {
                    "regex": /^\d{3}[ \.\-]\d{2}$/,
                    "alertText": "* Neplatné poštovné smerovacie číslo, tvar musí byť 456 45"
                },
                "url": {
                ...
                "ajaxUserCall": {
                    ...
                    "extraData": "name=eric",
                    "alertText": "* Používatelské méno je už použité",
                    "alertTextLoad": "* Overovánie, prosím počkajte"
                },
                "ajaxNameCall": {
                    ...
                    "alertTextOk": "* Toto méno je k dispozícii",
                    // speaks by itself
                    "alertTextLoad": "* Overovanie, prosím počkajte"
                },
                "validate2fields": {
