...
<body>
    <div class="widget-box">
        <div class="widget-title"><h5><span class="icon"><i class="icon-align-justify"></i></span> <spring:message code="update.reservation" text="Update reservation" /></h5></div>
        <div class="widget-content nopadding">
            <form:form modelAttribute="reservationForm" class="form-horizontal" method="post" action="${pageContext.request.contextPath}/admin/hotel/room/reservation/${hotelId}/${roomId}/${reservationId}/update-reservation">
