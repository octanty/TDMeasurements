...
<body>
    <div class="widget-box">
        <div class="widget-title"><h5><span class="icon"><i class="icon-align-justify"></i></span> <spring:message code="update.user" text="Update user" /></h5></div>
        <div class="widget-content nopadding">
            <form:form modelAttribute="userUpdateFormType" class="form-horizontal" method="post" action="${pageContext.request.contextPath}/admin/user/${userId}/update-user">
                ...
                <div class="control-group">
                    <form:label class="control-label" path="password"><spring:message code="password" text="Password" /></form:label>
                    <div class="controls">
